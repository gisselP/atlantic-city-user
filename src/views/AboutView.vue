          ...
          <div class="range range-50 range-md-justify range-sm-middle">
            <div class="cell-sm-6 wow fadeInUp" data-wow-delay=".1s">
              <div class="box-outline box-outline__mod-1">
                <figure><img src="../../public/assets/about-01-546x516.jpg" alt="" width="546" height="516"/>
                </figure>
              </div>
            </div>
      ...
      <section class="section section-md">
        <div class="shell">
          ...
          <div class="range range-30" data-lightgallery="group">
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-1-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-1-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-2-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-2-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-3-1058x800_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-3-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-4-1200x797_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-4-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-5-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-5-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
            ...
            <div class="cell-sm-6 cell-md-4"><a class="thumbnail-classic" href="../../public/assets/grid-gallery-6-1200x800_original.jpg" data-lightgallery="item">
                <figure><img src="../../public/assets/grid-gallery-6-370x276.jpg" alt="" width="370" height="276"/>
                </figure>
                <div class="caption">
              ...
              <div class="box-outline box-outline-fullwidth box-outline__mod-1">
                <div class="quote-carousel-wrap">
                  ...
                  <div class="slick-slider" id="child-carousel" data-for=".carousel-parent" data-arrows="false" data-loop="true" data-dots="false" data-swipe="true" data-center-mode="true" data-sm-center-mode="true" data-md-center-mode="true" data-lg-center-mode="true" data-center-padding="0.50" data-items="1" data-xs-items="1" data-sm-items="3" data-md-items="3" data-lg-items="3" data-slide-to-scroll="1">
                    <div class="item">
                      <figure><img class="img-circle" src="../../public/assets/about-02-100x100.jpg" alt="" width="100" height="100"/>
                      </figure>
                    </div>
                    <div class="item">
                      <figure><img class="img-circle" src="../../public/assets/about-04-100x100.jpg" alt="" width="100" height="100"/>
                      </figure>
                    </div>
                    <div class="item">
                      <figure><img class="img-circle" src="../../public/assets/about-05-100x100.jpg" alt="" width="100" height="100"/>
                      </figure>
                    </div>
                  </div>
                </div>
          ...
          <div class="range range-xs-center range-75">
            ...
            <div class="cell-sm-6 cell-md-4 wow fadeInUp" data-wow-delay=".1s">
              <div class="team-box box-outline">
                <div class="team-image-box"><img src="../../public/assets/team-01-295x282.jpg" alt="" width="295" height="282"/>
            ...
            <div class="cell-sm-6 cell-md-4 wow fadeInUp" data-wow-delay=".2s">
              <div class="team-box box-outline">
                <div class="team-image-box"><img src="../../public/assets/team-02-295x282.jpg" alt="" width="295" height="282"/>
                  <div class="team-image-caption">
                    <ul class="list-inline">
                      <li><a class="icon-sm icon-white fa-instagram icon" href="#"></a></li>
                      <li><a class="icon-sm icon-white fa-facebook icon" href="#"></a></li>
            ...
            <div class="cell-sm-6 cell-md-4 wow fadeInUp" data-wow-delay=".3s">
              <div class="team-box box-outline">
                <div class="team-image-box"><img src="../../public/assets/team-03-295x282.jpg" alt="" width="295" height="282"/>
                  <div class="team-image-caption">
                    <ul class="list-inline">
                      <li><a class="icon-sm icon-white fa-instagram icon" href="#"></a></li>
                      <li><a class="icon-sm icon-white fa-facebook icon" href="#"></a></li>
