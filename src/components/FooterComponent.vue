<template>
      <footer class="page-footer pt-4 text-left text-sm-left">
          ...
          <div class="range range-50">
            <div class="cell-sm-6 cell-md-3 cell-lg-4 wow fadeInUp" data-wow-delay=".1s">
              <div class="page-footer-minimal-inner">
                ...
                <ul class="list-unstyled">
                  ...
                  <li>
                    <p class="rights"><span>&copy;&nbsp;</span><span>2019</span><span>&nbsp;</span><span
                        class="copyright-year"></span>Royal Villas. All Rights Reserved. Design by <a
                ...
                <ul class="list-unstyled">
                  ...
                  <li>
                    <dl class="list-desc">
                      ...
                      <dd class="text-gray-darker">Call Us: <a class="link link-gray-darker" href="tel:#">+1 (409)
                          987–5874</a>
                      </dd>
                    </dl>
                  </li>
            ...
            <div class="cell-sm-8 cell-md-4 wow fadeInUp" data-wow-delay=".3s">
              <div class="page-footer-minimal-inner-subscribe">
                ...
                <!-- RD Mailform-->
                <form class="rd-mailform rd-mailform-inline form-center" data-form-output="form-output-global"
